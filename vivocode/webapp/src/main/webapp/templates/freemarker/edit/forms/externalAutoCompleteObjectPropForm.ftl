...
<#if editMode = "edit" >
	...
	<#---To Do: Will need to add something similar for object identifier if we are storing that -->
<#else>
...
${stylesheets.add('<link rel="stylesheet" href="${urls.base}/js/jquery-ui/css/smoothness/jquery-ui-1.12.1.css" />')}
 ...
 ${scripts.add('<script type="text/javascript" src="${urls.base}/js/jquery-ui/js/jquery-ui-1.12.1.min.js"></script>',
              ...
              '<script type="text/javascript" src="${urls.base}/js/browserUtils.js"></script>',
                          	...
                          	'<script type="text/javascript" src="${urls.base}/templates/freemarker/edit/forms/js/js_functions.js"></script>',             
              
            	'<script type="text/javascript" src="${urls.base}/templates/freemarker/edit/forms/js/customFormWithExternalAutocomplete_base.js"></script>',             
                            '<script type="text/javascript" src="${urls.base}/templates/freemarker/edit/forms/js/externallookup_solr.js"></script>',             
                 
              '<script type="text/javascript" src="${urls.base}/templates/freemarker/edit/forms/js/customFormWithExternalAutocomplete.js"></script>')}
