...
public class IndividualRequestInfo {
	...
	//the default response, but sent as JSON - i.e. what is actually displayed in the profile
	//And not the linked data request
	public static IndividualRequestInfo buildDefaultJSONInfo(Individual individual) {
