...
public class PropertyGroupTemplateModel extends BaseTemplateModel {
    ...
    public Model getPropertiesAsRDF() {
    	...
    	for(PropertyTemplateModel ptm: properties) {
    		if(ptm.getType().equals("object")) {
    			//object properties have ability to return
    			ObjectPropertyTemplateModel optm = (ObjectPropertyTemplateModel) ptm;
    			//Add RDF to Model
    			rdfModel.add(optm.getStatementDataAsRDF());
    		} else {
    			//Data property
    			DataPropertyTemplateModel dptm = (DataPropertyTemplateModel) ptm;
    			rdfModel.add(dptm.getStatementsAsRDF());
    		}
    	}
    	//RDF for all object properties
    	return rdfModel;
    }
}
